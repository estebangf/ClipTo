      ...
      <div className="space-y-10">
        ...
        <section className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Feature className="delay-300" title="Estadísticas detalladas" description="Monitorea los clics, dispositivos y ubicaciones de tus enlaces con un dashboard intuitivo." />
            <Feature className="delay-700" title="Fácil integración" description="Usa ClipTo en tus proyectos y aplicaciones con nuestra API REST." />
          </div>
        </section>
